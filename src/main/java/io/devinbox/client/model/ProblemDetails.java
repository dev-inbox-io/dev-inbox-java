...
public class ProblemDetails {
  ...
  public ProblemDetails status(@javax.annotation.Nullable ProblemDetailsStatus status) {
  ...
  public void setStatus(@javax.annotation.Nullable ProblemDetailsStatus status) {
    this.status = JsonNullable.<ProblemDetailsStatus>of(status);
  }
